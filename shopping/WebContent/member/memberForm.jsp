...
<form action="memJoin.mem" method="post" name="frm"> 
	<table border = 1 align="center">
		...
		<tr>
			<td>우편번호</td>
			<td><input type="text" name="postNumber" id="sample4_postcode"></td>   <!-- id를 써줘야 api사용가능   -->
		</tr>
		<tr>
			<td>주소</td>
			<td><input type="text" name="memAddress" id="sample4_roadAddress" size="30"><a href="javascript:sample4_execDaumPostcode();">주소 검색</a></td>
		</tr>
		<tr><td>상세주소</td>
