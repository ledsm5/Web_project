...
<input type = "hidden" name= "memId" value="${dto.memId }">
	<table border = 1 align="center">
		...
		<tr>
			<td>우편번호</td>
			<td><input type="text" name="postNumber" id="sample4_postcode" value="${dto.postNumber }"></td>   <!-- id를 써줘야 api사용가능   -->
		</tr>
		<tr>
			<td>주소</td>
			<td><input type="text" name="memAddress" id="sample4_roadAddress" size="30"><a href="javascript:sample4_execDaumPostcode();" value="${dto.memAddress }">주소 검색</a></td>
		</tr>
		<tr><td>상세주소</td>
		...
		<tr>
			...
			<td>
				...
				<c:if test="${dto.memGender == 'Y'}"> 여자  </c:if>			
			</td>
		</tr>
		<tr>
			<td>계좌번호</td>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input type = "button" value="회원탈퇴" onclick ="javascript:location.href='memDel.mem?memId=${dto.memId}'"> <!-- .mem은 스프링에서는 안쓴다  -->
			</td>
		</tr>
	</table>
</form>
