...
<script>
	function onQty(){
		...
		document.getElementNyId("tot").innerHTML = qty * ${dto.prodPrice }
	}
	function goodsCartAdd(prodMu,){
		var qty = document.frm.PurchaseQty.value;
		location.href="goodsCartAdd.gd?prodNum="+prodNum+"$qty="+qty+"&prodPrice=${dto.}";
	}
</script>
</head>
<body>
...
<form action="#" name="frm" method="post"></form>
	...
	<table width="800" align="center" border=1>
		...
		<tr><td colspan ="2">용량 : ${dto.prodCapacity} <br>
			...
			<img src="goods/upload/${file }"></c:forTokens>
	</table>
</body>
</html>